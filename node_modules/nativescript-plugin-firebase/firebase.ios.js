    ...
    if (user.providerData) {
        for (var i = 0, l = user.providerData.count; i < l; i++) {
            ...
            if (pid === 'facebook.com' && typeof (FBSDKAccessToken) !== "undefined") {
                ...
                var gidCurrentAccessToken = GIDSignIn.sharedInstance().currentUser.authentication.accessToken;
...
firebase_common_1.firebase.firestore._getCollectionReference = function (colRef) {
    ...
    return {
        ...
        startAfter: function (document) { return firebase_common_1.firebase.firestore.startAfter(collectionPath, document, colRef); },
        startAt: function (document) { return firebase_common_1.firebase.firestore.startAt(collectionPath, document, colRef); },
        endAt: function (document) { return firebase_common_1.firebase.firestore.endAt(collectionPath, document, colRef); },
        endBefore: function (document) { return firebase_common_1.firebase.firestore.endBefore(collectionPath, document, colRef); },
    };
};
